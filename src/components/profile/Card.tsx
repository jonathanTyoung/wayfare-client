      ...
      <div className="flex items-start justify-between">
        <div className="flex-1">
          <h1 className={`font-bold text-primary ${
            variant === "mini" ? "text-2xl" : 
            variant === "detailed" ? "text-5xl" : "text-4xl"
          }`}>
        ...
        <div className="ml-4 flex-shrink-0">
          <div className={`bg-primary text-white rounded-full flex items-center justify-center font-bold ${
            variant === "mini" ? "w-12 h-12 text-sm" :
            variant === "detailed" ? "w-20 h-20 text-2xl" : "w-16 h-16 text-lg"
          }`}>
